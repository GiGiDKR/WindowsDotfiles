...
modify(find='PowerRename' menu=title.more_options)
modify(find='File Locksmith' menu=title.more_options)
modify(find='compatibilité' menu=title.more_options)
modify(find='Microsoft Defender' menu=title.more_options)
